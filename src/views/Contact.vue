<template>
    <div class="bg-home">
        <section class="bread-crumb"
            :style="{ backgroundImage: `url(${require('@/assets/images/banner_page-lien.he.webp')})` }">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 col-12">
                        <div id="contact_map" class="map">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4649.107827886704!2d106.6845365!3d10.785581099999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752f07b3a24645%3A0x8190331668205de4!2zVMOyYSBuaMOgIEhNIFRvd24!5e1!3m2!1svi!2s!4v1743187900220!5m2!1svi!2s"
                        ...
                        <div class="contact">
                            ...
                            <div class="time_work">
                                ...
                                <div class="item">
                                    ...
                                    <b>Email:</b> <a href="mailto:recruit@bluesapphire.vn"
                                        title="support@sapo.vn">recruit@bluesapphire.vn</a>
                                </div>
                                <div class="item">
                                    ...
                                    <b>Hotline:</b> <a class="fone" href="tel:0976159787"
                                        title="19006750">0976.159.787</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div id="contact">
                                    <div class="group_contact">
                                        <a class="btn-lienhe" style="padding: 10px 20px;"
                                            href="mailTo:recruit@bluesapphire.vn">Gửi Thông tin</a>
                                    </div>
                                </div>
                            </div>
                        </div>
